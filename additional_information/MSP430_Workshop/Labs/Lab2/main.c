...
/*
    unter Controller ist temperatur-messer
    Ziel: mit Föhn den Controller erwärmen und wenn dieser eine bestimmte Temperatur erreicht hat, soll eine LED angehen

    https://www.badprog.com/electronics-msp430-using-the-temperature-demo-gui
